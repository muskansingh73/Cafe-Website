...
export default function CartSidebar() {
  ...
  const S = {
    ...
    drawer: {
      ...
      width: "min(420px, 100vw)",  // ← change this line
      background: "#FAF7F2", zIndex: 201, display: "flex", flexDirection: "column",
      boxShadow: "-8px 0 40px rgba(28,28,26,0.15)", fontFamily: "'Jost',sans-serif"
    },
   header: { 
  padding:"20px 20px 16px",  // ← reduced padding
  borderBottom:"1px solid #DDD5C8", display:"flex", justifyContent:"space-between", alignItems:"center" 
},
    ...
    footer: { padding:"16px 20px 24px", borderTop:"1px solid #DDD5C8" },
